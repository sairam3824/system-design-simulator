...
"[project]/Documents/Git/system-design/system-design-simulator/src/app/api/interview/[id]/analyze-phase/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        // Validate phase
        const phase = __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$src$2f$lib$2f$prompts$2f$interviewer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["INTERVIEW_PHASES"].find((p)=>p.id === phaseId);
        if (!phase) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Invalid phase"
            }, {
        ...
        const substantiveUserMessages = userMessages.filter((m)=>m.content.trim().split(/\s+/).length > 10);
        const conversationText = phaseMessages.map((m)=>`${m.role.toUpperCase()}: ${m.content}`).join("\n\n");
...
`;
        const analysisPrompt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$src$2f$lib$2f$prompts$2f$interviewer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPhaseAnalysisPrompt"])(phaseId, phase.name);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f874f5e9._.js.map
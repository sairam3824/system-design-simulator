...
"[project]/Documents/Git/system-design/system-design-simulator/src/app/api/profile/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request) {
    try {
        ...
        const { name, bio, yearsExperience, targetRole, skills, targetCompanies } = body;
        // Update user name
        if (name !== undefined) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.update({
                where: {
                    id: session.user.id
                },
                data: {
        ...
        // Upsert profile
        await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].profile.upsert({
            where: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3898b98f._.js.map
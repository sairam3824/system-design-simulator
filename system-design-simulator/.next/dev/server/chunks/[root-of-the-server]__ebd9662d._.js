...
"[project]/Documents/Git/system-design/system-design-simulator/src/lib/leaderboard.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getLeaderboard(filters, currentUserId, limit = 50) {
    ...
    const fetchLeaderboard = async ()=>{
        ...
        const usersWithStats = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findMany({
            where: {
                interviews: {
                    some: whereClause
                }
        ...
        const userStats = usersWithStats.map((user)=>{
            const scores = user.interviews.filter((i)=>i.score).map((i)=>i.score.overallScore);
            if (scores.length === 0) return null;
            const avgScore = scores.reduce((a, b)=>a + b, 0) / scores.length;
            const passCount = user.interviews.filter((i)=>i.score?.passStatus).length;
        ...
        let currentRank = 1;
        let currentScore = -1;
        const entries = userStats.slice(0, limit).map((stat, index)=>{
        ...
        let currentUserRank;
        if (currentUserId) {
            const currentUserIndex = userStats.findIndex((s)=>s.userId === currentUserId);
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$src$2f$lib$2f$cache$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrFetch"])(cacheKey, fetchLeaderboard, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$src$2f$lib$2f$redis$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["CACHE_TTL"].LEADERBOARD);
}
async function getLeaderboardTopics() {
    const topics = await __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].interview.findMany({
        where: {
            status: "completed"
        },
        select: {
...
"[project]/Documents/Git/system-design/system-design-simulator/src/app/api/leaderboard/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$src$2f$lib$2f$leaderboard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Documents/Git/system-design/system-design-simulator/src/lib/leaderboard.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$src$2f$lib$2f$leaderboard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
...
async function GET(request) {
    try {
        ...
        const leaderboard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$src$2f$lib$2f$leaderboard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLeaderboard"])({
            timeFrame,
            topic,
            difficulty
        }, currentUserId, limit);
        // Get available topics for filtering
        const availableTopics = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$src$2f$lib$2f$leaderboard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLeaderboardTopics"])();
        return __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$Git$2f$system$2d$design$2f$system$2d$design$2d$simulator$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...leaderboard,
            availableTopics
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ebd9662d._.js.map
...
import { MOCK_PERFORMANCE_METRICS } from "@/lib/mock-data";
...
export function PerformanceDashboard() {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        // Use Mock Data
        const data = { metrics: MOCK_PERFORMANCE_METRICS };
        // Simulate network delay
        await new Promise(resolve => setTimeout(resolve, 500));

        // Use Type Assertion to make TS happy since mock data might slightly mismatch purely on strict typing, but it matches structure
        setMetrics(data.metrics as unknown as PerformanceMetrics);
